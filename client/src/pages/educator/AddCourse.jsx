              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div
                      key={lectureIndex}
                      className="flex justify-between items-center mb-2 gap-y-4"
                    >
                      <span>
                        ...
                        <a
                          ...
                          target="_blank"
                          className="text-blue-500 gap-y-4"
                        >
                          Link
                        </a>
                  ...
                  <div
                    className="inline-flex bg-gray-300 p-2 rounded cursor-pointer mt-2 font-semibold"
