...
const CourseDetail = () => {
  ...
  const { allCourses,calculatRating, calculateChapterTime,
  ...
  return courseData ? (
    <>
      <div
        className="flex flex-col-reverse md:flex-row gap-10 relative items-start
     justify-between px-8 md:px-36 pt-20 md:pt-30 text-left"
      >
        <div
       ...
       bg-gradient-to-b from-cyan-100/70"
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
            ...
            <div className="flex ">
              {[...Array(5)].map((_, i) => (
                <img
                  key={i}
                  src={
                    i < Math.floor(calculatRating(courseData))
                      ? assets.star
                      : assets.star_blank
                  }
                  alt="rating"
            ...
            <p className="text-blue-700">({courseData.courseRatings.length} 
              ...
              {courseData.courseContent.map((chapter,index)=>(
                <div key = {index} className="border border-gray-300 bg-white mb-2 rounded">
                  ...
                  <div className={`overflow-hidden transition-all duration-300 ${openSection[index] ?
                                    'max-h-96' : 'max-h-0'}`}>
                     <ul className="list-disc md:pl-10 pl-4 py-2
                            ...
                            <p>{lecture.lectureTitle}</p>
                                <div className="flex gap-2 ">
                                  ...
                                  <p onClick={()=>setPlayerData({videoId: lecture.lectureUrl.split('/').pop()
                                   ...
                                   <p className="mr-4">{humanizeDuration(lecture.lectureDuration * 60 * 1000,
                                     {units: ['h', 'm']}
                                   )} </p>
                                </div>
                           </div>
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none
           ...
           <div className="p-5">
             ...
             <img className="w-3.5" src={assets.time_left_clock_icon} alt="time-left-clock-icons" />
             ...
             <div className="pt-6">
              <p className="md:text-xl text-lg font-medium text-gray-800">What's in the course?</p>
               <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Step-by-step, end-to-end project guidance</li>
