  ...
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 
          ...
          <div className='felx felx-col md:items-start items-center w-full'>
            <img src={assets.logo_dark} alt="logo" />
              <p className='mt-6 text-center md:text-left text-sm text-white/80'>Shaping the future of tech 
                       education with immersive,  
                hands-on <br />learning experiences built for tomorrow’s challenges.</p>
          </div>
        ...
        <p className='py-4 text-center text-xs md:text-sm text-white/60'> Copyright 2025 © Courseify. All Right Reserved</p>
    </footer>
  )
}
